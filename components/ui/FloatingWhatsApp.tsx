...
export default function FloatingWhatsApp() {
  return (
    <a
      ...
      <span className='absolute right-full mr-3 bg-white text-slate-800 text-xs font-bold px-2 py-1 rounded shadow-md opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none'>
        Chat Sekarang
      </span>
    </a>
  );
